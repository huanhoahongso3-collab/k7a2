...
import mc.dhp.foss.k7a2.procedures.K7A2AppleFoodEatenProcedure;
...
public class K7A2AppleItem extends Item {
	...
	public void appendHoverText(ItemStack itemstack, Level level, List<Component> list, TooltipFlag flag) {
		...
		list.add(Component.translatable("item.k7a2.k_7_a_2_apple.description_0"));
	}
	...
	public ItemStack finishUsingItem(ItemStack itemstack, Level world, LivingEntity entity) {
		...
		K7A2AppleFoodEatenProcedure.execute(entity);
		return retval;
	}
}