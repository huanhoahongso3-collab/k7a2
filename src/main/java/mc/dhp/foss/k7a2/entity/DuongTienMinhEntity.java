...
public class DuongTienMinhEntity extends Villager {
	public DuongTienMinhEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.DUONG_TIEN_MINH.get(), world);
	}

	public DuongTienMinhEntity(EntityType<DuongTienMinhEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(10, new AvoidEntityGoal<>(this, NguyenTungLamEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(11, new AvoidEntityGoal<>(this, NguyenPhamMinhChauEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(12, new AvoidEntityGoal<>(this, TranKhanhGiangEntity.class, (float) 6, 1, 1.2));
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("k7a2:duongminh"));
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.DUONG_TIEN_MINH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
