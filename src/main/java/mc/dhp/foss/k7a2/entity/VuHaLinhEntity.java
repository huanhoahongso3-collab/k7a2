...
public class VuHaLinhEntity extends Villager {
	public VuHaLinhEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.VU_HA_LINH.get(), world);
	}

	public VuHaLinhEntity(EntityType<VuHaLinhEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("k7a2:vhlinh"));
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.VU_HA_LINH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
