...
public class NguyenTuUyenEntity extends Monster {
	public NguyenTuUyenEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.NGUYEN_TU_UYEN.get(), world);
	}

	public NguyenTuUyenEntity(EntityType<NguyenTuUyenEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("k7a2:uyen"));
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.NGUYEN_TU_UYEN.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
