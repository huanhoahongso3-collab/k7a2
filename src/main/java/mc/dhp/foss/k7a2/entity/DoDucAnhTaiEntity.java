...
public class DoDucAnhTaiEntity extends Villager {
	public DoDucAnhTaiEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.DO_DUC_ANH_TAI.get(), world);
	}

	public DoDucAnhTaiEntity(EntityType<DoDucAnhTaiEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("k7a2:tai"));
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.DO_DUC_ANH_TAI.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
