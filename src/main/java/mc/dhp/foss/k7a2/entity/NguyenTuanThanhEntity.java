...
public class NguyenTuanThanhEntity extends Villager {
	public NguyenTuanThanhEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.NGUYEN_TUAN_THANH.get(), world);
	}

	public NguyenTuanThanhEntity(EntityType<NguyenTuanThanhEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(K7a2ModItems.SMURFCAT.get()));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("block.wooden_trapdoor.open"));
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.NGUYEN_TUAN_THANH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
