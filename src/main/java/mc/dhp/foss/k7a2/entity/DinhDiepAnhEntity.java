...
public class DinhDiepAnhEntity extends Villager {
	public DinhDiepAnhEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.DINH_DIEP_ANH.get(), world);
	}

	public DinhDiepAnhEntity(EntityType<DinhDiepAnhEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(12, new AvoidEntityGoal<>(this, TranHaLinhEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(13, new AvoidEntityGoal<>(this, NguyenTungLamEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(14, new AvoidEntityGoal<>(this, NguyenHaMinhEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(15, new AvoidEntityGoal<>(this, VuThanhThaoEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(16, new AvoidEntityGoal<>(this, VuKhanhNganEntity.class, (float) 6, 1, 1.2));
	}
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("block.brewing_stand.brew"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("block.end_portal.spawn")), 0.15f, 1);
	}
