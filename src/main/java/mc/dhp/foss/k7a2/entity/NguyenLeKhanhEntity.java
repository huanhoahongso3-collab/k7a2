...
public class NguyenLeKhanhEntity extends Villager {
	public NguyenLeKhanhEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.NGUYEN_LE_KHANH.get(), world);
	}

	public NguyenLeKhanhEntity(EntityType<NguyenLeKhanhEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(14, new AvoidEntityGoal<>(this, VuKhanhNganEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(15, new AvoidEntityGoal<>(this, NguyenHaMinhEntity.class, (float) 6, 1, 1.2));
	...
	protected void dropCustomDeathLoot(DamageSource source, int looting, boolean recentlyHitIn) {
		...
		this.spawnAtLocation(new ItemStack(K7a2ModItems.THIEN_LY_OI.get()));
	}

	@Override
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("k7a2:khanh"));
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.NGUYEN_LE_KHANH.get(), SpawnPlacements.Type.NO_RESTRICTIONS, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES, Mob::checkMobSpawnRules);
	}
