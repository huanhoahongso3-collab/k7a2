...
public class NguyenThiNgocAnhEntity extends Villager {
	public NguyenThiNgocAnhEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.NGUYEN_THI_NGOC_ANH.get(), world);
	}

	public NguyenThiNgocAnhEntity(EntityType<NguyenThiNgocAnhEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(10, new AvoidEntityGoal<>(this, TranKhanhGiangEntity.class, (float) 6, 1, 1.2));
		this.goalSelector.addGoal(11, new AvoidEntityGoal<>(this, NguyenPhamMinhChauEntity.class, (float) 6, 1, 1.2));
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("block.lava.pop"));
	}

	@Override
	public void playStepSound(BlockPos pos, BlockState blockIn) {
		this.playSound(ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("block.wool.hit")), 0.15f, 1);
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.NGUYEN_THI_NGOC_ANH.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
