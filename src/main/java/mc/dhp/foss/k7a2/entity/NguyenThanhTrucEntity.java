...
public class NguyenThanhTrucEntity extends Villager {
	public NguyenThanhTrucEntity(PlayMessages.SpawnEntity packet, Level world) {
		this(K7a2ModEntities.NGUYEN_THANH_TRUC.get(), world);
	}

	public NguyenThanhTrucEntity(EntityType<NguyenThanhTrucEntity> type, Level world) {
		super(type, world);
		setMaxUpStep(0.6f);
		xpReward = 0;
		setNoAi(false);
	...
	public SoundEvent getAmbientSound() {
		return ForgeRegistries.SOUND_EVENTS.getValue(ResourceLocation.parse("entity.iron_golem.damage"));
	}
	...
	public static void init() {
		SpawnPlacements.register(K7a2ModEntities.NGUYEN_THANH_TRUC.get(), SpawnPlacements.Type.ON_GROUND, Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
