...
import net.mcreator.k7a2.item.ThienLyOiItem;
import net.mcreator.k7a2.item.TNTChargeItem;
import net.mcreator.k7a2.item.TNTBowItem;
import net.mcreator.k7a2.item.TNTArrowItem;
import net.mcreator.k7a2.item.SuperK7A2IngotItem;
import net.mcreator.k7a2.item.SmurfcatItem;
import net.mcreator.k7a2.item.RawK7A2EnchantedAppleItem;
import net.mcreator.k7a2.item.OldNetheriteSpammableSwordItem;
import net.mcreator.k7a2.item.OPBowItem;
import net.mcreator.k7a2.item.NightChangeItem;
import net.mcreator.k7a2.item.MaGamingRapItem;
import net.mcreator.k7a2.item.K7a2mixeddiscItem;
import net.mcreator.k7a2.item.K7A2ingotItem;
import net.mcreator.k7a2.item.K7A2ToolGettingBlockItem;
import net.mcreator.k7a2.item.K7A2SwordItem;
import net.mcreator.k7a2.item.K7A2StickItem;
import net.mcreator.k7a2.item.K7A2ShovelItem;
import net.mcreator.k7a2.item.K7A2ShearsItem;
import net.mcreator.k7a2.item.K7A2PickaxeItem;
import net.mcreator.k7a2.item.K7A2NuggetItem;
import net.mcreator.k7a2.item.K7A2LavaItem;
import net.mcreator.k7a2.item.K7A2HoeItem;
import net.mcreator.k7a2.item.K7A2EnchantedAppleItem;
import net.mcreator.k7a2.item.K7A2DimItem;
import net.mcreator.k7a2.item.K7A2CarrotItem;
import net.mcreator.k7a2.item.K7A2AxeItem;
import net.mcreator.k7a2.item.K7A2ArmorItem;
import net.mcreator.k7a2.item.K7A2AppleItem;
import net.mcreator.k7a2.item.IfIAmWithYouItem;
import net.mcreator.k7a2.item.HanhKhucCBHItem;
import net.mcreator.k7a2.item.FlorentinoItem;
import net.mcreator.k7a2.item.EndermanSecretItem;
import net.mcreator.k7a2.item.EndermanHackWindows10SItem;
import net.mcreator.k7a2.item.DeathNoteItem;
import net.mcreator.k7a2.item.DeadlyBowItem;
import net.mcreator.k7a2.item.BuonHayVuiItem;
import net.mcreator.k7a2.item.BedrockInstantMinePickaxeItem;
import net.mcreator.k7a2.item.BattleGoldenAxeItem;
import net.mcreator.k7a2.item.AetherItem;
