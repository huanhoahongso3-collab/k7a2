...
public class K7A2BiomeLeaveDecorator extends LeaveVineDecorator {
	public static Codec<LeaveVineDecorator> CODEC = Codec.unit(K7A2BiomeLeaveDecorator::new);
	...
	public K7A2BiomeLeaveDecorator() {
		super(0.25f);
	}
