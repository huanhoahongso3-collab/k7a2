...
public class K7A2BiomeFruitDecorator extends CocoaDecorator {
	public static Codec<K7A2BiomeFruitDecorator> CODEC = Codec.unit(K7A2BiomeFruitDecorator::new);
	...
	public K7A2BiomeFruitDecorator() {
		super(0.2f);
	}
